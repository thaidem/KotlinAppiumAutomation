...
abstract class SearchPageObject(driver: AppiumDriver<MobileElement>?) : MainPageObject(driver)
{
    ...
    {
        this.checkWordsInResult(SEARCH_RESULT_TITLE_LIST, request,"Cannot find request '$request' into each result items",5)
    }
